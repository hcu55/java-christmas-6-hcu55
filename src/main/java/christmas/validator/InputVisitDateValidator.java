...
public class InputVisitDateValidator {
    ...
    private static final String WRONG_INPUT_DATE_ERROR_MESSAGE = "[ERROR] 유효하지 않은 날짜입니다. 다시 입력해 주세요.";
    ...
    public void validateWrongRangeVisitDate(String visitDate) {
        ...
        if (date < MIN_VISIT_DATE || date > MAX_VISIT_DATE) {
            throw new IllegalArgumentException(WRONG_INPUT_DATE_ERROR_MESSAGE);
        }
    }
